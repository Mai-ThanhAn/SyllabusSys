...
from services.smart_diff_service import generate_smart_diff
...
@generation_bp.route("/generate-smart-diff", methods=["POST"])
def generate_smart_diff_route():
    try:
        data = request.get_json()
        ...
        result = generate_smart_diff(data)
