...
class SyllabusShellController extends Controller
{
    public function create()
    {
        ...
        $courses = Course::where('program_id', $user->program_id)->get();
        ...
        return view('program_director.syllabus_shells.create', compact(
            'courses',
            'templates',
            'lecturers',
            'plos',
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request) {
            $assignedStatus = Status::where('status_name', 'Assigned')->firstOrFail();
        ...
        return redirect()
            ...
            ->with('success', 'Tạo khung đề cương và phân công giảng viên thành công.');
    }
}
