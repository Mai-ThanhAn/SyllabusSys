...
class SyllabusSectionController extends Controller
{
    public function index(int $templateId)
    {
        ...
        return view('admin.syllabus_sections.index', compact('template', 'sections'));
    }
    ...
    public function create(int $templateId)
    {
        ...
        return view('admin.syllabus_sections.create', compact('template'));
    }
    ...
    public function store(Request $request, int $templateId)
    {
        ...
        return redirect()
            ->route('syllabus-templates.sections.index', $templateId)
            ->with('success', 'Thêm mục đề cương thành công.');
    }
    ...
    public function edit(int $templateId, int $sectionId)
    {
        ...
        return view('admin.syllabus_sections.edit', compact('template', 'section'));
    }
    ...
    public function update(Request $request, int $templateId, int $sectionId)
    {
        ...
        return redirect()
            ->route('syllabus-templates.sections.index', $templateId)
            ->with('success', 'Cập nhật mục đề cương thành công.');
    }
    ...
    public function destroy(int $templateId, int $sectionId)
    {
        ...
        return redirect()
            ->route('syllabus-templates.sections.index', $templateId)
            ->with('success', 'Xóa mục đề cương thành công.');
    }
}
