...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex items-center gap-2 mb-4 text-on-surface-variant">
        <a href="{{ route('department.syllabus-templates.index') }}"
            ...
            <span class="font-label text-label-md tracking-widest uppercase">Quay lại danh sách</span>
        </a>
    </div>
    ...
    <div class="w-full max-w-2xl glass-panel rounded-xl p-8 border border-outline-variant/10 relative overflow-hidden">
        ...
        <form method="POST" action="{{ route('department.syllabus-templates.store') }}" class="space-y-6">
            ...
            <div class="space-y-2 group">
                <label class="font-label text-label-md text-on-surface-variant uppercase tracking-widest flex items-center gap-2 group-focus-within:text-primary transition-colors"
                    for="template_name">
                    Tên khung
            ...
            <div class="space-y-2 group">
                ...
                <div class="relative">
                    <select name="program_id" id="program_id"
                        class="w-full bg-surface-container-lowest border border-outline-variant/20 rounded-lg py-4 px-4 text-on-surface font-body appearance-none focus:ring-primary/20 focus:outline-none focus:border-primary transition-all cursor-pointer">
                ...
                <p class="text-[10px] text-on-surface-variant/60 italic mt-1">
                    Chương trình đào tạo mà khung đề cương này sẽ được áp dụng.
                </p>
            </div>
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <label class="font-label text-label-md text-on-surface-variant uppercase tracking-widest cursor-pointer select-none"
                    for="is_active">
            ...
            <div class="pt-8 flex items-center justify-end gap-4 border-t border-outline-variant/10">
                ...
                <button class="px-10 py-3 rounded-lg bg-primary-container text-on-primary-container font-bold shadow-extruded hover:brightness-110 active:scale-95 transition-all flex items-center gap-2 group"
                    type="submit">
...
<script>
    ...
    // Optional: Auto-close alerts after 5 seconds
    setTimeout(() => {
        document.querySelectorAll('.bg-error-container\\/10').forEach(alert => {
            if (alert) {
