        ...
        <div class="w-full max-w-2xl glass-panel rounded-xl p-8 border border-outline-variant/10 relative overflow-hidden">
            ...
            <form method="POST" action="{{ route('department.syllabus-templates.store') }}" class="space-y-6">
                ...
                <div class="space-y-2 group">
                    <label
                        class="font-label text-label-md text-on-surface-variant uppercase tracking-widest flex items-center gap-2 group-focus-within:text-primary transition-colors"
                        for="template_name">
                        Tên khung
                    ...
                    <div class="relative">
                        <input
                            class="w-full bg-surface-container-lowest border border-outline-variant/20 rounded-lg py-4 px-4 text-on-surface font-body shadow-inset-soft transition-all focus:ring-primary/20 focus:outline-none focus:border-primary"
                            id="template_name" name="template_name"
                            placeholder="VD: Khung chương trình đào tạo kỹ sư phần mềm 2024" type="text"
                ...
                <div class="space-y-2 group">
                    ...
                    <textarea
                        class="w-full bg-surface-container-lowest border border-outline-variant/20 rounded-lg py-4 px-4 text-on-surface font-body shadow-inset-soft transition-all focus:ring-primary/20 focus:outline-none focus:border-primary resize-none"
                        id="description" name="description" placeholder="Nhập thông tin mô tả chi tiết cho khung đề cương này..."
                ...
                <div class="space-y-2">
                    ...
                    <select name="program_id"
                        class="w-full bg-surface-container-lowest border border-outline-variant/20 rounded-lg py-4 px-4">
                ...
                <div class="flex items-center gap-3 pt-2">
                    <div class="relative inline-block w-12 h-6 cursor-pointer">
                        <input class="sr-only peer" id="is_active" name="is_active" type="checkbox"
                            {{ old('is_active', '1') == '1' ? 'checked' : '' }}>
                        <div
                            class="w-full h-full bg-surface-container-highest rounded-full transition-colors peer-checked:bg-primary/40 border border-outline-variant/30">
                        </div>
                        <div
                            class="absolute left-1 top-1 w-4 h-4 bg-on-surface-variant rounded-full transition-all peer-checked:translate-x-6 peer-checked:bg-primary shadow-lg">
                        </div>
                    </div>
                    <label
                        class="font-label text-label-md text-on-surface-variant uppercase tracking-widest cursor-pointer select-none"
                        for="is_active">
                ...
                <div class="pt-8 flex items-center justify-end gap-4 border-t border-outline-variant/10">
                    <a href="{{ route('department.syllabus-templates.index') }}"
                        class="px-6 py-3 rounded-lg font-label text-label-md uppercase tracking-widest text-on-surface-variant hover:text-on-surface transition-colors">
                        Hủy bỏ
                    </a>
                    <button
                        class="px-10 py-3 rounded-lg bg-primary-container text-on-primary-container font-bold shadow-extruded hover:brightness-110 active:scale-95 transition-all flex items-center gap-2 group"
                        type="submit">
                        <span
                            class="material-symbols-outlined text-sm transition-transform group-hover:rotate-12">save</span>
                        Lưu thiết lập
                    </button>
                </div>
            </form>
        ...
        <div class="w-full max-w-2xl mt-8 grid grid-cols-3 gap-6">
            <div class="col-span-2 bg-surface-container-low rounded-xl p-6 border border-outline-variant/5">
                ...
                <p class="text-xs text-on-surface-variant/60 leading-relaxed font-label">
                    Templates created will be immediately available for syllabus mapping across all departments. Ensure the
                    CLO (Course Learning Outcomes) structure matches the accreditation standards.
                </p>
            </div>
            <div
                class="bg-surface-container-low rounded-xl p-6 border border-outline-variant/5 flex flex-col justify-center">
