                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-surface-container-high/50 border-b border-outline-variant/10">
                            ...
                            <th class="px-6 py-4 font-label text-[10px] uppercase tracking-widest text-outline">Tên CTĐT</th>
                            <th class="px-6 py-4 font-label text-[10px] uppercase tracking-widest text-outline">Giám đốc CTĐT</th>
                    ...
                    <tbody class="divide-y divide-outline-variant/5">
                        ...
                        <tr class="group hover:bg-surface-container-low transition-colors">
                            ...
                            <td class="px-6 py-5">
                                ...
                                @else
                                <div class="flex items-center gap-2">
                                    <span class="material-symbols-outlined text-[14px] text-outline">person_off</span>
                            ...
                            <td class="px-6 py-5 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <!-- Xóa -->
                                    <form method="POST" action="{{ route('department.programs.destroy', $program->id) }}"
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-24 text-center">
                                <div class="flex flex-col items-center gap-4 opacity-40">
                                    ...
                                    <p class="font-label text-sm uppercase tracking-widest">Chưa có chương trình đào tạo nào</p>
                                    <p class="text-xs text-outline">Bắt đầu bằng cách thêm chương trình đào tạo đầu tiên.</p>
                                    <a href="{{ route('department.programs.create') }}"
        ...
        <div class="mt-8 flex flex-col md:flex-row md:items-center justify-between gap-4 border-t border-outline-variant/10 pt-6">
            ...
            <div class="flex gap-8">
                <div class="flex flex-col">
                    <span class="font-label text-[9px] uppercase tracking-widest text-outline">Total Programs</span>
                    <span class="text-[10px] font-bold text-primary">{{ $programs->count() }} Chương trình</span>
                </div>
                <div class="flex flex-col">
