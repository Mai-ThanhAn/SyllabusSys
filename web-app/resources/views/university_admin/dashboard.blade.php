...
@section('content')
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div
                class="group relative overflow-hidden rounded-2xl bg-surface-container-low border border-outline-variant/10 p-8 hover:border-primary/30 transition-all duration-300 hover:scale-[1.02]">
                <div class="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                    <span class="material-symbols-outlined text-7xl">admin_panel_settings</span>
                </div>
                <div class="relative z-10">
                    <div
                        class="w-14 h-14 rounded-xl bg-primary-container/20 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                    ...
                    <p class="text-sm text-on-surface-variant mb-6 leading-relaxed">
                        Quản lý người dùng toàn hệ thống, phân quyền truy cập theo vai trò (Admin, Trưởng viện, Giám đốc
                        CTĐT, Giảng viên).
                    </p>
            ...
            <div
                class="group relative overflow-hidden rounded-2xl bg-surface-container-low border border-outline-variant/10 p-8 hover:border-secondary/30 transition-all duration-300 hover:scale-[1.02]">
                <div class="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                    <span class="material-symbols-outlined text-7xl">account_balance</span>
                </div>
                <div class="relative z-10">
                    <div
                        class="w-14 h-14 rounded-xl bg-secondary-container/20 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
            ...
            <div class="bg-surface-container-low rounded-2xl border border-outline-variant/10 overflow-hidden">
                <div class="p-6 border-b border-outline-variant/10">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="font-label text-xs uppercase tracking-widest text-outline font-bold">Thống kê hệ thống
                        </h3>
                    </div>
                </div>
                <div class="p-6 space-y-4">
        ...
        cards.forEach(card => {
            card.addEventListener('mousemove', (e) => {
                ...
                card.style.background =
                    `radial-gradient(circle at ${x}px ${y}px, rgba(94, 106, 210, 0.08) 0%, rgba(28, 27, 29, 0.95) 60%)`;
            });
